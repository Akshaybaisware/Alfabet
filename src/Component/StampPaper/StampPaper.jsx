...
import front from "../../Images/alfabet legal.svg";
import stamplogo from "../../Images/Alfabet-stamp.svg";
    ...
    <>
      ...
      <Box textAlign="center">
        ...
        <Text fontSize={"1.5rem"}>
          <strong>Alfabet Service of </strong>
        </Text>
        <Text>
        ...
        <Box>
          ...
          >
            ...
            <br />
            * YOUR AGREEMENT IS MADE FOR 11 MONTHS WITH Alfabet Service COMPANY.
            <br />
            <br />
            ...
            followed. cut off - 47 (in total) below 90% @43/- INR perform. if
          ...
          >
            ...
            issued by the Contractor. This General Alfabet Service Stands and is
            valid for 11 months, if the client or contractor is willing to end
            this business relationship they need to proceed with the termination
            of this agreement-based contract.
            <br />
          </Text>
        </Box>
        ...
        <Box mt={["-1rem", "-5rem"]}>
          ...
          >
            ...
            and Alfabet Service freelancing services will not be responsible for
            any future data and payment to the Client and the Client will be
