      ...
      <Box ref={targetRef} p="20px">
        ...
        <Box display="flex" justifyContent="space-evenly">
          ...
          <Box textAlign="center">
            ...
            <Text>
              <Heading fontSize="1.2rem">Alfabet Service </Heading>
            </Text>
            <Text fontSize="1rem">
              KASTURI WADI INDRA BAZAR GHANSHAM APARTMENT JAIPUR, RAJASTHAN
              (RJ), INDIA(IN), 302031 of
        ...
        <Box>
          ...
          <Text fontSize="md">
            ...
            Effect. And Alfabet service Will Not Be Responsible For Any Further
        ...
        <Box>
          ...
          <Text fontSize="md">
            ...
            Address : Mara Rani Apartment office 189 Janganana Bhawan, First and
